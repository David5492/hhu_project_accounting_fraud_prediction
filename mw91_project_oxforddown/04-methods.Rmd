...
y_pred_logit_all_data <- predict.glm(logit_all_data, X_test, type = "response" )
...
y_pred_logit_raw_data <- predict.glm(logit_raw_data, X_test, type = "response" )
...
y_pred_logit_ratio_data <- predict.glm(logit_ratio_data, X_test, type = "response" )
